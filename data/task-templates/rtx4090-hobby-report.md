...
3. EMAIL: Send email to {{email_to}} using the sendEmail function from /home/julian/temp/justclaw/dist/email.js. Subject: "{{email_subject}} — {{DATE}}". Body: the full report as plain text with hyperlinks. Load .env from /home/julian/temp/justclaw/.env for SMTP config.
